                   ...
                   if (isset($_SESSION['cart'])){
                    ...
                    while ($row = mysqli_fetch_assoc($result)){
                        foreach ($book_id as $id){
                            if ($row['id'] == $id){
                                cartElement($row['bkName'],$row['bkText'], $row['bkImg'], $row['id']);
                            }
                        }
                    }
                }else{
                    ...
                    <div class="col-md-6">
                        <?php
                            if (isset($_SESSION['cart'])){
                                ...
                                if($count > 1){
                                    echo "<h6>Added ($count books)</h6>";
                                } else {
                                    echo "<h6>Added ($count book)</h6>";
                                }
                               
                            }else{
                                echo "<h6>Added (0 book)</h6>";
                            }
                        ?>
